...
from tests.test_app_background.test_import.test_geo_points.constants import PATH


@pytest.mark.parametrize("r_cu", [pytest.lazy_fixture("cu_owner_fi")])
def test__patch_method__fail(api_client, r_cu, get_background_task_fi: Callable):
