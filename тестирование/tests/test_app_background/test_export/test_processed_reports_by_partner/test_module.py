...
from tests.test_app_background.test_export.test_processed_reports_by_partner.constants import MODEL_N_TYPE
...
def test__contractor_export_processed_reports__output_files(
    ...
    __mock_response = MockResponse(status_code=HTTP_202_ACCEPTED, data={"result": {"objstore_id": "234"}})
